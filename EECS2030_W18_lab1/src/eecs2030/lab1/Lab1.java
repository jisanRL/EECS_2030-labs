...
public class Lab1 {
	 ...
	 */
	public static final int QUARTER_VALUE = 25; // changed
	...
	public static int numQuarters(int cents) {
		return cents / Lab1.QUARTER_VALUE;
	}
	...
	public static int compareTo(Range r1, Range r2) {
		...
		double wad = r1.getMaximum() - r1.getMinimum();
		double wid = r2.getMaximum() - r2.getMinimum();
		if (wad < wid) {
			rex = -1;
		} else if (wad > wid) {
			rex = 1;
