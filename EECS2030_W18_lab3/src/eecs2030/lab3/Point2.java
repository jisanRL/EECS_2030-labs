 ...
 * {@code Point2} instance has an x and y coordinate.
 * 
...
public class Point2 {
	...
	/**
	 * Sets the x-coordinate and y-coordinate of this point to {@code newX} and
	 * {@code newY}, respectively.
	 * 
	 * @param newX
	 *            the new x-coordinate of this point
	 * @param newY
	...
	/**
	 * Compares this point with the given object. The result is {@code true} if and
	 * only if the argument is not {@code null} and is a {@code Point2} object
	 * having the same coordinates as this object.
	 * 
	 * @param obj
	 ...
	 * @return true if the length of (this - other) is less than tol, and false
	 *         otherwise
	 */
