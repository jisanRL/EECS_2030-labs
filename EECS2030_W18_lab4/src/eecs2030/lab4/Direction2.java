...
public final class Direction2 {
	...
	// public Direction2(Direction2 direction) {
	...
	/**
	 * Compares this direction to the specified object. The result is true if and
	 * only if the argument is not null and is a {@code Direction2} object that
	 * represents the same direction as this object.
	 * 
	 * @param obj
	 *            the object to compare this Direction2 against
	 * @return true if the given object represents a Direction2 equivalent to this
