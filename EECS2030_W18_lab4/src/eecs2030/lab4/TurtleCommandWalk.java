...
public class TurtleCommandWalk extends TurtleCommand {
	 ...
	 * turtle executing a {@code walk(distance)} command.
	 * 
	 * @param turtle
	 *            the turtle that is associated with this command
	 * @param distance
	 *            the distance of the walk command
	 */
	...
	/**
	 * Runs the method {@code walk(distance)} using the turtle associated with this
	 * command.
	 */
	@Override
	public void execute() {
