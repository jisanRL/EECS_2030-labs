...
public class BinarySearchTree<E extends Comparable<? super E>> {
	 ...
	 * 
	 * @param <E>
	 *            the type of the data element stored in the node
	 */
	public static class Node<E> {
		...
		/**
		 * Create a node with the given data element. The left and right child nodes are
		 * set to null.
		 * 
		 * @param data
	...
	/**
	 * Add an element to the subtree rooted at <code>root</code>. The element is
	 * inserted into the tree in a position that preserves the definition of a
	 * binary search tree.
	 * 
	 * @param element
	...
	/**
	 * Returns <code>true</code> if the subtree rooted at <code>root</code> contains
	 * the given element, <code>false</code> otherwise.
	 * 
	 * @param element
	 *            the element to search for
	 * @param root
	 *            the root of the subtree
	 * @return <code>true</code> if the subtree rooted at <code>root</code> contains
	 *         the given element, <code>false</code> otherwise
	 */
	...
	/**
	 * Return a string representation of the subtree rooted at <code>root</code>.
	 * 
	 * <p>
	 * The string is made up of the elements stored in the tree separated by commas
	 ...
	 * <li>the string corresponding to <code>root.right()</code> is computed
	 * </ol>
	 * 
	 * <p>
